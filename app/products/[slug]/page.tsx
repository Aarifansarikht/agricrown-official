...
import { Check, Share2, Printer, ZoomIn, ArrowUpRight } from 'lucide-react';
             ...
             <div className="grid grid-cols-4 gap-4">
               {allImages.map((img, idx) => (
                 <button 
                  ...
                  className={cn(
                    "relative aspect-square border p-2 cursor-pointer transition-all hover:opacity-100 bg-zinc-50 dark:bg-zinc-900",
                    activeImage === idx 
