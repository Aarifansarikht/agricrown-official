    ...
    >
      ...
      <div className="relative h-[50vh] flex items-center overflow-hidden bg-zinc-900 text-white">
        <div className="absolute inset-0 z-0">
             <img src="https://images.unsplash.com/photo-1592323089535-649fa7e4b2d3?q=80&w=2000&auto=format&fit=crop" className="w-full h-full object-cover opacity-50" alt="Products" />
